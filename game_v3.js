...
if (!localStorage.getItem('giveaway_fuse_luck_10m_v7')) {
    triggerLuckEvent(10);
    triggerTrophyLuckEvent(10);
    saveGame();
    localStorage.setItem('giveaway_fuse_luck_10m_v7', 'true');
    setTimeout(() => {
        showFireworks();
        logEvent('🎁 운영자의 깜짝 선물! 퓨즈 럭 & 트로피 2배 10분이 발동되었습니다!', 'success');
    }, 1000);
}
